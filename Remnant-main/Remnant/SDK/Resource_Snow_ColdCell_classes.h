...
// BlueprintGeneratedClass Resource_Snow_ColdCell.Resource_Snow_ColdCell_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Resource_Snow_ColdCell.Resource_Snow_ColdCell_C");
		return ptr;
	}
