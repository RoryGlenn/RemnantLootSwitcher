...
// 0x0734 (FullSize[0x1210] - InheritedSize[0x0ADC])
class UMod_IronSentinel_AnimBP_C : public URemnantAnimInstance
{
public:
	unsigned char                                      UnknownData_GNPH[0x4];                                     // 0x0ADC(0x0004) Fix Super Size
	...
	unsigned char                                      UnknownData_01UX[0x3];                                     // 0x1209(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
