...
void UWidget_Inventory_C::SetAction(int Type, const struct FText& ActionLabel, bool Valid)
{
...
void UWidget_Inventory_C::FindInfo(const struct FInspectInfo& InspectInfo, int InfoNumber, struct FInspectStat* Array_Element)
{
...
void UWidget_Inventory_C::ShowQuickSelect(const struct FName& Radial)
{
...
// Parameters:
// struct FText                   ActionLabel                    (BlueprintVisible, BlueprintReadOnly, Parm)
void UWidget_Inventory_C::BndEvt__ItemInfo_K2Node_ComponentBoundEvent_1_OnSubAction__DelegateSignature(const struct FText& ActionLabel)
{
...
void UWidget_Inventory_C::BndEvt__InventoryList_K2Node_ComponentBoundEvent_2_OnSelectItem__DelegateSignature(int ItemID, const struct FInspectInfo& InspectInfo, bool Comparing, const struct FInspectInfo& InspectInfoCompare, bool ShowIngredients, const struct FRecipeInfo& Recipe, class UClass* ItemBP)
{
...
// Parameters:
// struct FText                   ActionLabel                    (BlueprintVisible, BlueprintReadOnly, Parm)
void UWidget_Inventory_C::BndEvt__ResumeInfo_K2Node_ComponentBoundEvent_3_OnSubAction__DelegateSignature(const struct FText& ActionLabel)
{
