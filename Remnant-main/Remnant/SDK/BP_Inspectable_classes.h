...
// 0x0080 (FullSize[0x0428] - InheritedSize[0x03A8])
...
public:
	...
	unsigned char                                      UnknownData_FWYV[0x7];                                     // 0x03B1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	void On_Inspectable_Complete(const struct FName& Result);
	...
	void OnNotifyRead__DelegateSignature(const struct FBookPage& Page);
