...
// BlueprintGeneratedClass Breakable_Snow_Crate_A.Breakable_Snow_Crate_A_C
// 0x0030 (FullSize[0x04E0] - InheritedSize[0x04B0])
class ABreakable_Snow_Crate_A_C : public ABP_BreakableActor_2States_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Breakable_Snow_Crate_A.Breakable_Snow_Crate_A_C");
		return ptr;
	}
