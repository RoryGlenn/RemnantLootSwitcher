...
// BlueprintGeneratedClass BP_Snow_Campfire_Interior.BP_Snow_Campfire_Interior_C
// 0x0028 (FullSize[0x0358] - InheritedSize[0x0330])
class ABP_Snow_Campfire_Interior_C : public AActor
{
public:
	struct FPointerToUberGraphFrame                    UberGraphFrame;                                            // 0x0330(0x0008) (ZeroConstructor, Transient, DuplicateTransient)
	class UAudioComponent*                             Bonfire_Loop_SC;                                           // 0x0338(0x0008) (BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_Snow_Campfire_Interior.BP_Snow_Campfire_Interior_C");
		return ptr;
	}


	void ReceiveBeginPlay();
	void ExecuteUbergraph_BP_Snow_Campfire_Interior(int EntryPoint);
};
