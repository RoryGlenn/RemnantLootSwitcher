...
// 0x0072 (FullSize[0x04FA] - InheritedSize[0x0488])
...
public:
	...
	unsigned char                                      UnknownData_VV32[0x7];                                     // 0x04D9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_PCDV[0x3];                                     // 0x04E9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
