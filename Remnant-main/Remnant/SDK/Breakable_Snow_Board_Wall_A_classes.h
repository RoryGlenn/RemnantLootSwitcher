...
// BlueprintGeneratedClass Breakable_Snow_Board_Wall_A.Breakable_Snow_Board_Wall_A_C
// 0x0038 (FullSize[0x04E8] - InheritedSize[0x04B0])
class ABreakable_Snow_Board_Wall_A_C : public ABP_BreakableActor_2States_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Breakable_Snow_Board_Wall_A.Breakable_Snow_Board_Wall_A_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_Breakable_Snow_Board_Wall_A(int EntryPoint);
};
