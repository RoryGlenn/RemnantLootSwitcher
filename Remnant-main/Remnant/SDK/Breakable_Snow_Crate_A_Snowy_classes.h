...
// BlueprintGeneratedClass Breakable_Snow_Crate_A_Snowy.Breakable_Snow_Crate_A_Snowy_C
// 0x0030 (FullSize[0x04E0] - InheritedSize[0x04B0])
class ABreakable_Snow_Crate_A_Snowy_C : public ABP_BreakableActor_2States_C
{
public:
	...
	class UParticleSystemComponent*                    P_SwampFatty_Crate_A;                                      // 0x04D8(0x0008) (BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Breakable_Snow_Crate_A_Snowy.Breakable_Snow_Crate_A_Snowy_C");
		return ptr;
	}
