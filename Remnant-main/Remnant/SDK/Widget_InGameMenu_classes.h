...
{
public:
	unsigned char                                      UnknownData_H698[0x7];                                     // 0x0249(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_OUE2[0x4];                                     // 0x037C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	void CreateTabPanel(const struct FName& Widget, class UClass* WidgetBP, class UUserWidget** Out);
	void IsTabFocused(const struct FName& Widget, bool* Out);
	void CreateAndFocusWidget(const struct FName& Widget, class UClass* WidgetBP, class UWidget_TabButton_C* TabButton);
