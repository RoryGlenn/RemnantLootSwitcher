...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Tracer_Ambusher_Shotgun.Tracer_Ambusher_Shotgun_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_Tracer_Ambusher_Shotgun(int EntryPoint);
};
