...
// 0x034B (FullSize[0x0594] - InheritedSize[0x0249])
class UWidget_InventoryList_C : public UWidget_UserWidget_C
{
public:
	unsigned char                                      UnknownData_FGE4[0x7];                                     // 0x0249(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_SD7Q[0x3];                                     // 0x04E9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_FNGW[0x1];                                     // 0x04F7(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_J1AU[0x7];                                     // 0x0509(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_P41M[0x7];                                     // 0x0521(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_SY1E[0x6];                                     // 0x053A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VLKF[0x5];                                     // 0x0553(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	void SetItemType(class UClass* Type, class UClass* Category, bool FocusEquippedItem, const struct FName& EquipSlotName);
	void FocusItem(int ItemID, bool InactiveFocus);
	void ShowInactiveFocus(bool Allow);
	void IsEmpty(bool* Rtn);
	void AddInventoryItem(struct FInventoryItem* Item, class UInventoryComponent* Inventory, int ItemIndex);
	...
	void OnSelectItem__DelegateSignature(int ItemID, const struct FInspectInfo& InspectInfo, bool Comparing, const struct FInspectInfo& InspectInfoCompare, bool ShowIngredients, const struct FRecipeInfo& Recipe, class UClass* ItemBP);
};
