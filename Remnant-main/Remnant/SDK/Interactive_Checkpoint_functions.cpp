...
void AInteractive_Checkpoint_C::RemoveCheckpointNotification(class ACharacter_Master_Player_C* Player, const struct FName& NameID)
{
...
void AInteractive_Checkpoint_C::AddCheckpointNotification(class ACharacter_Master_Player_C* Player, const struct FName& NameID, float DurationOverride)
{
...
// struct FName                   NameID                         (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                           Out                            (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor)
void AInteractive_Checkpoint_C::IsCheckpointNotificationActive(class ACharacter_Master_Player_C* Player, const struct FName& NameID, bool* Out)
{
...
void AInteractive_Checkpoint_C::BndEvt__StateMachine_K2Node_ComponentBoundEvent_0_InteractiveDelegate__DelegateSignature(const struct FName& StateName, class AActor* Other)
{
