...
// 0x00A8 (FullSize[0x0358] - InheritedSize[0x02B0])
...
public:
	...
	unsigned char                                      UnknownData_GTQR[0x7];                                     // 0x0349(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	void SetIcon(const struct FString& Type);
