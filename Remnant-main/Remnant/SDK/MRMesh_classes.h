...
public:
	...
	unsigned char                                      UnknownData_2ECP[0x4];                                     // 0x026C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_RWSD[0x4];                                     // 0x02A4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TDZV[0x20];                                    // 0x02B0(0x0020) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_MG5U[0x8];                                     // 0x0578(0x0008) Fix Super Size
	...
	unsigned char                                      UnknownData_H5S4[0x5];                                     // 0x058B(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TEWK[0x28];                                    // 0x05A8(0x0028) MISSED OFFSET (PADDING)
