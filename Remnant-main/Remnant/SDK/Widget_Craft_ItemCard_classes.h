...
// 0x0117 (FullSize[0x0360] - InheritedSize[0x0249])
class UWidget_Craft_ItemCard_C : public UWidget_UserWidget_C
{
public:
	unsigned char                                      UnknownData_1L7S[0x7];                                     // 0x0249(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_UEPK[0x2];                                     // 0x032E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_JDS8[0x4];                                     // 0x0334(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	void SetInfo(const struct FInspectInfo& Info, int LevelOverride, const struct FRecipeInfo& Recipe);
