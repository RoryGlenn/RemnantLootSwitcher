...
// 0x06C1 (FullSize[0x1391] - InheritedSize[0x0CD0])
...
public:
	...
	unsigned char                                      UnknownData_XA0E[0x2];                                     // 0x0FAA(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Y9PB[0x7];                                     // 0x0FC9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_L1ZZ[0x4];                                     // 0x0FE4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_PTPU[0x2];                                     // 0x1006(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      WeaponKillRecords[0x10];                                   // 0x1028(0x0010) UNKNOWN PROPERTY: ArrayProperty Character_Master_Player.Character_Master_Player_C.WeaponKillRecords
	...
	unsigned char                                      UnknownData_8A54[0x4];                                     // 0x1044(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_FJTE[0x7];                                     // 0x1059(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_4TOB[0x5];                                     // 0x107B(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	unsigned char                                      Twitch___Flight_Team_Cap[0x28];                            // 0x1080(0x0028) UNKNOWN PROPERTY: SoftClassProperty Character_Master_Player.Character_Master_Player_C.Twitch - Flight Team Cap
	unsigned char                                      Steam___Bomber_Hat[0x28];                                  // 0x10A8(0x0028) UNKNOWN PROPERTY: SoftClassProperty Character_Master_Player.Character_Master_Player_C.Steam - Bomber Hat
	unsigned char                                      Gladiator_Head[0x28];                                      // 0x10D0(0x0028) UNKNOWN PROPERTY: SoftClassProperty Character_Master_Player.Character_Master_Player_C.Gladiator Head
	unsigned char                                      Gladiator_Body[0x28];                                      // 0x10F8(0x0028) UNKNOWN PROPERTY: SoftClassProperty Character_Master_Player.Character_Master_Player_C.Gladiator Body
	unsigned char                                      Gladiator_Legs[0x28];                                      // 0x1120(0x0028) UNKNOWN PROPERTY: SoftClassProperty Character_Master_Player.Character_Master_Player_C.Gladiator Legs
	unsigned char                                      Doomsayer_Head[0x28];                                      // 0x1148(0x0028) UNKNOWN PROPERTY: SoftClassProperty Character_Master_Player.Character_Master_Player_C.Doomsayer Head
	unsigned char                                      Doomsayer_Body[0x28];                                      // 0x1170(0x0028) UNKNOWN PROPERTY: SoftClassProperty Character_Master_Player.Character_Master_Player_C.Doomsayer Body
	unsigned char                                      Doomsayer_Legs[0x28];                                      // 0x1198(0x0028) UNKNOWN PROPERTY: SoftClassProperty Character_Master_Player.Character_Master_Player_C.Doomsayer Legs
	unsigned char                                      Nightstalker_Head[0x28];                                   // 0x11C0(0x0028) UNKNOWN PROPERTY: SoftClassProperty Character_Master_Player.Character_Master_Player_C.Nightstalker Head
	unsigned char                                      Nightstalker_Body[0x28];                                   // 0x11E8(0x0028) UNKNOWN PROPERTY: SoftClassProperty Character_Master_Player.Character_Master_Player_C.Nightstalker Body
	unsigned char                                      Nightstalker_Legs[0x28];                                   // 0x1210(0x0028) UNKNOWN PROPERTY: SoftClassProperty Character_Master_Player.Character_Master_Player_C.Nightstalker Legs
	unsigned char                                      Survivor_Bag[0x28];                                        // 0x1238(0x0028) UNKNOWN PROPERTY: SoftClassProperty Character_Master_Player.Character_Master_Player_C.Survivor Bag
	unsigned char                                      GameAwards___BomberHat[0x28];                              // 0x1260(0x0028) UNKNOWN PROPERTY: SoftClassProperty Character_Master_Player.Character_Master_Player_C.GameAwards - BomberHat
	...
	unsigned char                                      UnknownData_3JXX[0x3];                                     // 0x128D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      Xbox___BomberHat[0x28];                                    // 0x12B0(0x0028) UNKNOWN PROPERTY: SoftClassProperty Character_Master_Player.Character_Master_Player_C.Xbox - BomberHat
	...
	unsigned char                                      UnknownData_899H[0x4];                                     // 0x12DC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_DSZJ[0x4];                                     // 0x12F4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VTWX[0x3];                                     // 0x1301(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_68XA[0x4];                                     // 0x130C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6BM3[0x7];                                     // 0x1321(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	unsigned char                                      StoredRecorders[0x10];                                     // 0x1328(0x0010) UNKNOWN PROPERTY: ArrayProperty Character_Master_Player.Character_Master_Player_C.StoredRecorders
	...
	unsigned char                                      UnknownData_D4ZN[0x4];                                     // 0x1344(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	void OnPingMenuEnded(const struct FName& Result);
	...
	void DLC_Logging(const struct FString& String);
	...
	void OnFailure_B965762A445B982708DF2D8FEEDBC3E2(const struct FName& WrittenAchievementName, float WrittenProgress, int WrittenUserTag);
	void OnSuccess_B965762A445B982708DF2D8FEEDBC3E2(const struct FName& WrittenAchievementName, float WrittenProgress, int WrittenUserTag);
	void OnFailure_04E1D90C4785AB7500A9C4BD5BE4C84B(const struct FName& WrittenAchievementName, float WrittenProgress, int WrittenUserTag);
	void OnSuccess_04E1D90C4785AB7500A9C4BD5BE4C84B(const struct FName& WrittenAchievementName, float WrittenProgress, int WrittenUserTag);
	void OnFailure_744C71424FAEFE20C17A84A02737DAD7(const struct FName& WrittenAchievementName, float WrittenProgress, int WrittenUserTag);
	void OnSuccess_744C71424FAEFE20C17A84A02737DAD7(const struct FName& WrittenAchievementName, float WrittenProgress, int WrittenUserTag);
	void OnFailure_5B892AD148B8A7E4AE0373B595B54D75(const struct FName& WrittenAchievementName, float WrittenProgress, int WrittenUserTag);
	void OnSuccess_5B892AD148B8A7E4AE0373B595B54D75(const struct FName& WrittenAchievementName, float WrittenProgress, int WrittenUserTag);
	void OnFailure_4B4588704DF8E6E4EC7A40A9B7AA37D9(const struct FName& WrittenAchievementName, float WrittenProgress, int WrittenUserTag);
	void OnSuccess_4B4588704DF8E6E4EC7A40A9B7AA37D9(const struct FName& WrittenAchievementName, float WrittenProgress, int WrittenUserTag);
	void OnFailure_5E04062640ABD461EA31B792B4659C7F(const struct FName& WrittenAchievementName, float WrittenProgress, int WrittenUserTag);
	void OnSuccess_5E04062640ABD461EA31B792B4659C7F(const struct FName& WrittenAchievementName, float WrittenProgress, int WrittenUserTag);
	void OnFailure_14840F50467879E63F4FC8BBF4158F11(const struct FName& WrittenAchievementName, float WrittenProgress, int WrittenUserTag);
	void OnSuccess_14840F50467879E63F4FC8BBF4158F11(const struct FName& WrittenAchievementName, float WrittenProgress, int WrittenUserTag);
	void OnFailure_B3F0A23548B1471DE982029336B3238A(const struct FName& WrittenAchievementName, float WrittenProgress, int WrittenUserTag);
	void OnSuccess_B3F0A23548B1471DE982029336B3238A(const struct FName& WrittenAchievementName, float WrittenProgress, int WrittenUserTag);
	void OnFailure_6DA9194F48388CE31CA7DCBC6FA2C8F6(const struct FName& WrittenAchievementName, float WrittenProgress, int WrittenUserTag);
	void OnSuccess_6DA9194F48388CE31CA7DCBC6FA2C8F6(const struct FName& WrittenAchievementName, float WrittenProgress, int WrittenUserTag);
	void OnFailure_64CE77C3491A077E1BB3CCB9ABEB390C(const struct FName& WrittenAchievementName, float WrittenProgress, int WrittenUserTag);
	void OnSuccess_64CE77C3491A077E1BB3CCB9ABEB390C(const struct FName& WrittenAchievementName, float WrittenProgress, int WrittenUserTag);
	void OnFailure_64629C8140FC7F24E521E99EAAF74C4B(const struct FName& WrittenAchievementName, float WrittenProgress, int WrittenUserTag);
	void OnSuccess_64629C8140FC7F24E521E99EAAF74C4B(const struct FName& WrittenAchievementName, float WrittenProgress, int WrittenUserTag);
	void OnFailure_D212BFC048A1255C560CBBBD13D96EDA(const struct FName& WrittenAchievementName, float WrittenProgress, int WrittenUserTag);
	void OnSuccess_D212BFC048A1255C560CBBBD13D96EDA(const struct FName& WrittenAchievementName, float WrittenProgress, int WrittenUserTag);
	void OnFailure_06C191CA4361D74F447A59BC1DF8DE1A(const struct FName& WrittenAchievementName, float WrittenProgress, int WrittenUserTag);
	void OnSuccess_06C191CA4361D74F447A59BC1DF8DE1A(const struct FName& WrittenAchievementName, float WrittenProgress, int WrittenUserTag);
	void OnFailure_E43E11DF45EA2007993D4E92724C4FC2(const struct FName& WrittenAchievementName, float WrittenProgress, int WrittenUserTag);
	void OnSuccess_E43E11DF45EA2007993D4E92724C4FC2(const struct FName& WrittenAchievementName, float WrittenProgress, int WrittenUserTag);
	void OnFailure_39ADB5624FB857C60172D5B95C6ECEAC(const struct FName& WrittenAchievementName, float WrittenProgress, int WrittenUserTag);
	void OnSuccess_39ADB5624FB857C60172D5B95C6ECEAC(const struct FName& WrittenAchievementName, float WrittenProgress, int WrittenUserTag);
	void OnFailure_5A87EB2F4B337BA5BA86699897E4B9F8(const struct FName& WrittenAchievementName, float WrittenProgress, int WrittenUserTag);
	void OnSuccess_5A87EB2F4B337BA5BA86699897E4B9F8(const struct FName& WrittenAchievementName, float WrittenProgress, int WrittenUserTag);
	void OnFailure_D6DB88DF4493C5760967508B47A06AB3(const struct FName& WrittenAchievementName, float WrittenProgress, int WrittenUserTag);
	void OnSuccess_D6DB88DF4493C5760967508B47A06AB3(const struct FName& WrittenAchievementName, float WrittenProgress, int WrittenUserTag);
	void OnFailure_8F2349F443528EB971D9D28ABCA8F70F(const struct FName& WrittenAchievementName, float WrittenProgress, int WrittenUserTag);
	void OnSuccess_8F2349F443528EB971D9D28ABCA8F70F(const struct FName& WrittenAchievementName, float WrittenProgress, int WrittenUserTag);
	void OnFailure_C37F6928477ED7394B76848A247D809F(const struct FName& WrittenAchievementName, float WrittenProgress, int WrittenUserTag);
	void OnSuccess_C37F6928477ED7394B76848A247D809F(const struct FName& WrittenAchievementName, float WrittenProgress, int WrittenUserTag);
	void OnFailure_EF5700BD42FEE53DF81784AB624E114B(const struct FName& WrittenAchievementName, float WrittenProgress, int WrittenUserTag);
	void OnSuccess_EF5700BD42FEE53DF81784AB624E114B(const struct FName& WrittenAchievementName, float WrittenProgress, int WrittenUserTag);
	void OnFailure_A7C6D7124B54BD212A425F8222BB92EB(const struct FName& WrittenAchievementName, float WrittenProgress, int WrittenUserTag);
	void OnSuccess_A7C6D7124B54BD212A425F8222BB92EB(const struct FName& WrittenAchievementName, float WrittenProgress, int WrittenUserTag);
	void OnFailure_A6F3616442127DE33894FBAEE666DDD8(const struct FName& WrittenAchievementName, float WrittenProgress, int WrittenUserTag);
	void OnSuccess_A6F3616442127DE33894FBAEE666DDD8(const struct FName& WrittenAchievementName, float WrittenProgress, int WrittenUserTag);
	void InpActEvt_ToggleWeapon_K2Node_InputActionEvent_15(const struct FKey& Key);
	void InpActEvt_QuickSelect1_K2Node_InputActionEvent_14(const struct FKey& Key);
	void InpActEvt_QuickSelect2_K2Node_InputActionEvent_13(const struct FKey& Key);
	void InpActEvt_QuickSelect3_K2Node_InputActionEvent_12(const struct FKey& Key);
	void InpActEvt_QuickSelect4_K2Node_InputActionEvent_11(const struct FKey& Key);
	void InpActEvt_Ping_K2Node_InputActionEvent_10(const struct FKey& Key);
	void InpActEvt_Ping_K2Node_InputActionEvent_9(const struct FKey& Key);
	void InpActEvt_GodMode_K2Node_InputActionEvent_8(const struct FKey& Key);
	void InpActEvt_ToggleUntargetable_K2Node_InputActionEvent_7(const struct FKey& Key);
	void InpActEvt_DebugHurtSelf_K2Node_InputActionEvent_6(const struct FKey& Key);
	void InpActEvt_DebugKillSelf_K2Node_InputActionEvent_5(const struct FKey& Key);
	void InpActEvt_ResourceHack_K2Node_InputActionEvent_4(const struct FKey& Key);
	void InpActEvt_GiveCraftingMaterials_K2Node_InputActionEvent_3(const struct FKey& Key);
	void InpActEvt_SkipIntro_K2Node_InputActionEvent_2(const struct FKey& Key);
	void OnLoaded_E0E805FD4AD71513D4F4B691FA157880(class UClass* Loaded);
	void InpActEvt_DebugInterruptSelf_K2Node_InputActionEvent_1(const struct FKey& Key);
	void StartHighFive();
	void StopHighFive();
	...
	void OnClientStateChange(const struct FName& StateName, const struct FName& PreviousStateName);
	...
	void CheckpointEnd();
	void EventOnDialogResult(const struct FName& Result);
	...
	void ServerZoneDoorFailedNotify(class ARemnantCharacter* Player, const struct FName& NameID);
	void MulticastZoneDoorFailedNotify(class ARemnantCharacter* Player, const struct FName& NameID);
	void LocalZoneDoorFailedNotify(class ARemnantCharacter* Player, const struct FName& NameID);
	...
	void OnPlayVapor();
	void Dodged(const struct FName& EventName);
	void OnPerfectDodge();
