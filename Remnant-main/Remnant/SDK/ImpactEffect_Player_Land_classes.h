...
// BlueprintGeneratedClass ImpactEffect_Player_Land.ImpactEffect_Player_Land_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass ImpactEffect_Player_Land.ImpactEffect_Player_Land_C");
		return ptr;
	}
