...
public:
	...
	unsigned char                                      UnknownData_HOWV[0x2C];                                    // 0x002C(0x002C) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_7FZC[0x128];                                   // 0x0060(0x0128) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YH85[0x4];                                     // 0x018C(0x0004) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_AYZW[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_G3AN[0x10];                                    // 0x0050(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_7VMP[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_CXD7[0x8];                                     // 0x0038(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_WB5A[0xA8];                                    // 0x0058(0x00A8) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_W873[0xA8];                                    // 0x0058(0x00A8) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_WUAC[0x2];                                     // 0x05AA(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_5MYW[0x30];                                    // 0x05BC(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_BHTM[0xF];                                     // 0x05F1(0x000F) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_CCJE[0x24];                                    // 0x005C(0x0024) MISSED OFFSET (PADDING)
