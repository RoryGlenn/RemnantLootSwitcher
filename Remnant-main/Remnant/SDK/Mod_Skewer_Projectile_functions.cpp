...
void AMod_Skewer_Projectile_C::OnProjectileHit(const struct FHitResult& Hit)
{
...
void AMod_Skewer_Projectile_C::ExecuteUbergraph_Mod_Skewer_Projectile(int EntryPoint)
{
