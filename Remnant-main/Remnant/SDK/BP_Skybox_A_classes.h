...
// 0x07E1 (FullSize[0x0B11] - InheritedSize[0x0330])
...
public:
	...
	unsigned char                                      UnknownData_L5KB[0x7];                                     // 0x03B9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_CQ7J[0x3];                                     // 0x0A81(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HHAZ[0x4];                                     // 0x0A8C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	unsigned char                                      Override_WastelandClouds[0x28];                            // 0x0A90(0x0028) UNKNOWN PROPERTY: SoftObjectProperty BP_Skybox_A.BP_Skybox_A_C.Override_WastelandClouds
	unsigned char                                      Override_WastelandBlackSun[0x28];                          // 0x0AB8(0x0028) UNKNOWN PROPERTY: SoftObjectProperty BP_Skybox_A.BP_Skybox_A_C.Override_WastelandBlackSun
	...
	unsigned char                                      SoftObjRefs[0x10];                                         // 0x0AF8(0x0010) UNKNOWN PROPERTY: ArrayProperty BP_Skybox_A.BP_Skybox_A_C.SoftObjRefs
	...
	void OverrideTesting(const struct FName& RowName);
