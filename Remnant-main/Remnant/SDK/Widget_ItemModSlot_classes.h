...
// 0x01CB (FullSize[0x0420] - InheritedSize[0x0255])
class UWidget_ItemModSlot_C : public UWidget_StatBase_C
{
public:
	unsigned char                                      UnknownData_CSII[0x3];                                     // 0x0255(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ILAA[0x7];                                     // 0x0291(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_NMIW[0x7];                                     // 0x0379(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
