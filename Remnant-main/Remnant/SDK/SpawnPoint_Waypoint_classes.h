...
// BlueprintGeneratedClass SpawnPoint_Waypoint.SpawnPoint_Waypoint_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass SpawnPoint_Waypoint.SpawnPoint_Waypoint_C");
		return ptr;
	}
