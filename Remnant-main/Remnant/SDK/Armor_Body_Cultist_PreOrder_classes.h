...
// BlueprintGeneratedClass Armor_Body_Cultist_PreOrder.Armor_Body_Cultist_PreOrder_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Armor_Body_Cultist_PreOrder.Armor_Body_Cultist_PreOrder_C");
		return ptr;
	}
