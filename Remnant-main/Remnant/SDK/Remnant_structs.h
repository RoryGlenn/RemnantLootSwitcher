...
struct FRemnantQuestRewardItem
{
	...
	unsigned char                                      UnknownData_9UB1[0x8];                                     // 0x0018(0x0008) MISSED OFFSET (PADDING)
...
struct FRemnantQuestReward
{
	...
	unsigned char                                      UnknownData_87CL[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_IGFW[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_RVQI[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FPersistentBuff
{
	...
	unsigned char                                      UnknownData_ZGFR[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
struct FSpawnedGrenadeRepData
{
	...
	unsigned char                                      UnknownData_A0J5[0x8];                                     // 0x0018(0x0008) MISSED OFFSET (PADDING)
...
struct FGunObstructionParameters
{
	...
	unsigned char                                      UnknownData_N6KY[0x2];                                     // 0x000A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FLootContainerItem
{
	...
	unsigned char                                      UnknownData_CROD[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (PADDING)
...
struct FLorePage
{
	...
	unsigned char                                      UnknownData_ART8[0x3];                                     // 0x0029(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_UEIQ[0x20];                                    // 0x0000(0x0020) MISSED OFFSET (PADDING)
...
struct FRadialShortcut
{
	...
	unsigned char                                      UnknownData_LHVS[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FArchetypeStartingTrait
{
	...
	unsigned char                                      UnknownData_BAPS[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAccountCurrencyInstance
{
	...
	unsigned char                                      UnknownData_MG48[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (PADDING)
...
struct FAccountAwardInstance
{
	...
	unsigned char                                      UnknownData_P63I[0x6];                                     // 0x000A(0x0006) MISSED OFFSET (PADDING)
...
struct FSavedEquipmentVisual
{
	...
	unsigned char                                      UnknownData_TVW8[0x7];                                     // 0x0031(0x0007) MISSED OFFSET (PADDING)
...
struct FPrimaryPingInfo
{
	...
	unsigned char                                      UnknownData_5Y4M[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_H8IH[0x18];                                    // 0x0000(0x0018) MISSED OFFSET (PADDING)
...
struct FBookPage
{
	...
	unsigned char                                      UnknownData_GXPC[0x3];                                     // 0x0021(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WW8E[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_KN6V[0x18];                                    // 0x0000(0x0018) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_B830[0x18];                                    // 0x0000(0x0018) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_9BCP[0x18];                                    // 0x0000(0x0018) MISSED OFFSET (PADDING)
...
struct FCheatProtectedItemParams
{
	...
	unsigned char                                      UnknownData_OQXX[0x1];                                     // 0x000F(0x0001) MISSED OFFSET (PADDING)
...
struct FAutoUpgradeableItem
{
	...
	unsigned char                                      UnknownData_LR0R[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (PADDING)
...
struct FRemnantQuestEntityInfo
{
	...
	unsigned char                                      UnknownData_YVBH[0x3];                                     // 0x0089(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HTZE[0x8];                                     // 0x0098(0x0008) MISSED OFFSET (PADDING)
...
struct FRemnantQuestEntry
{
	...
	unsigned char                                      UnknownData_BIU6[0x6];                                     // 0x0092(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_SAXR[0x9];                                     // 0x00BF(0x0009) MISSED OFFSET (PADDING)
...
struct FRemnantCharacterStatData : public FStatData
{
	...
	unsigned char                                      UnknownData_N6WH[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (PADDING)
...
struct FZoneState
{
	...
	unsigned char                                      UnknownData_DJN3[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FZoneLinkInfo
{
	...
	unsigned char                                      UnknownData_O2YO[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_H0LP[0x1];                                     // 0x0063(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FZoneTravelState
{
	...
	unsigned char                                      UnknownData_M8EJ[0x2];                                     // 0x0002(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_G984[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FActionPing
{
	...
	unsigned char                                      UnknownData_35BP[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YDTA[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WLXC[0x7];                                     // 0x0041(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
