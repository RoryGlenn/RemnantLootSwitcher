...
public:
	...
	unsigned char                                      UnknownData_16FB[0x7];                                     // 0x03C9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	void SetQuestInfo(const struct FRemnantQuestEntry& Info, bool Valid);
	void Refresh();
	void Construct();
