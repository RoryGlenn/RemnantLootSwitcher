...
// 0x009A (FullSize[0x034A] - InheritedSize[0x02B0])
...
public:
	...
	unsigned char                                      UnknownData_VY0U[0x7];                                     // 0x0309(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_2D8G[0x4];                                     // 0x031C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
