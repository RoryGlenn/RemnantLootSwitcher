...
void UWidget_MaterialsQuestsMiscs_C::FindInfo(const struct FInspectInfo& InspectInfo, int InfoNumber, struct FInspectStat* Array_Element)
{
...
void UWidget_MaterialsQuestsMiscs_C::ShowQuickSelect(const struct FName& Radial)
{
...
// class UClass*                  ItemBP                         (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
void UWidget_MaterialsQuestsMiscs_C::BndEvt__InventoryList_K2Node_ComponentBoundEvent_0_OnSelectItem__DelegateSignature(int ItemID, const struct FInspectInfo& InspectInfo, bool Comparing, const struct FInspectInfo& InspectInfoCompare, bool ShowIngredients, const struct FRecipeInfo& Recipe, class UClass* ItemBP)
{
...
// struct FRecipeInfo             Recipe                         (BlueprintVisible, BlueprintReadOnly, Parm)
// class UClass*                  ItemBP                         (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
void UWidget_MaterialsQuestsMiscs_C::OnSelectItem_Event(int ItemID, const struct FInspectInfo& InspectInfo, bool Comparing, const struct FInspectInfo& InspectInfoCompare, bool ShowIngredients, const struct FRecipeInfo& Recipe, class UClass* ItemBP)
{
...
void UWidget_MaterialsQuestsMiscs_C::OnDialogResult_Event_1(const struct FName& Result)
{
