...
{
public:
	unsigned char                                      UnknownData_M6IR[0x3];                                     // 0x02ED(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YNXF[0x3];                                     // 0x0309(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_KY58[0x3];                                     // 0x0319(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Action_Frost_Cloud_DOT.Action_Frost_Cloud_DOT_C");
		return ptr;
	}
	...
	void OnActionStart();
	void OnActionStop();
	void ExecuteUbergraph_Action_Frost_Cloud_DOT(int EntryPoint);
};
