...
// 0x010F (FullSize[0x0358] - InheritedSize[0x0249])
class UWidget_Window_C : public UWidget_UserWidget_C
{
public:
	unsigned char                                      UnknownData_Q3VR[0x7];                                     // 0x0249(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_929M[0x3];                                     // 0x02A9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_PP5P[0x4];                                     // 0x02B4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	void SetCaption(const struct FText& Text);
