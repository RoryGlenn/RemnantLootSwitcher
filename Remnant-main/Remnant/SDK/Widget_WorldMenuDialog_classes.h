...
// 0x02B0 (FullSize[0x04F0] - InheritedSize[0x0240])
...
public:
	...
	unsigned char                                      UnknownData_WDGV[0x4];                                     // 0x046C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_4KVA[0x7];                                     // 0x0489(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_597I[0x7];                                     // 0x0499(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	void GetDescriptionTextFromDifficulty(int Difficulty, const struct FStruct_DifficultyDescription& DescriptionStruct, struct FText* OutText);
	...
	void BeginCreateQuest(const struct FText& CreateBtnLabel);
	...
	void CreateQuestEvent(const struct FRemnantQuestEntry& Quest);
