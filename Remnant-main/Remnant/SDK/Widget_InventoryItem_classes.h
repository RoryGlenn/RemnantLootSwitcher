...
// 0x0209 (FullSize[0x04B9] - InheritedSize[0x02B0])
...
public:
	...
	unsigned char                                      UnknownData_MCH3[0x4];                                     // 0x038C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Y1JQ[0x3];                                     // 0x03A9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_EGI1[0x4];                                     // 0x03B4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3V7W[0x7];                                     // 0x03D1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YHYD[0x2];                                     // 0x048E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WRN0[0x4];                                     // 0x04A4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	void MarkUpgradeIngredientsForRemoval(const struct FRecipeInfo& Recipe);
	...
	void SetInspectInfo(const struct FInspectInfo& InspectInfo);
	struct FLinearColor Get_Border_4_BrushColor_1();
	void GetCost(int* Cost);
	void GetPrimaryStat(const struct FInspectInfo& InspectInfo, struct FInspectStat* InspectStat, bool* Out);
	...
	void GetRecipeCost(const struct FRecipeInfo& RecipeInfo, int* Cost);
	void SelectItem();
	...
	void DoUpgrade();
	void OnUpgradeResult(const struct FName& Result);
	void OnBuyResult(const struct FName& Result);
	void Construct();
