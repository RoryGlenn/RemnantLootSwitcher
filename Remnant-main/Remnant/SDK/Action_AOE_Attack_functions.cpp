...
void UAction_AOE_Attack_C::DoSecondaryEffect(class AActor* Target, float Falloff, const struct FDamageInfo& DamageInfo)
{
...
struct FVector UAction_AOE_Attack_C::Get_Socket_Location(const struct FName& InSocketName)
{
