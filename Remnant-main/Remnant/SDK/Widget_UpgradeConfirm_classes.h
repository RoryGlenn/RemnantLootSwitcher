...
// 0x0177 (FullSize[0x03C0] - InheritedSize[0x0249])
class UWidget_UpgradeConfirm_C : public UWidget_UserWidget_C
{
public:
	unsigned char                                      UnknownData_CFIR[0x7];                                     // 0x0249(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	void ExecuteUbergraph_Widget_UpgradeConfirm(int EntryPoint);
};
