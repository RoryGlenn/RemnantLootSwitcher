...
void AMod_HiveShot_Projectile_C::OnProjectileHit(const struct FHitResult& Hit)
{
...
void AMod_HiveShot_Projectile_C::ExecuteUbergraph_Mod_HiveShot_Projectile(int EntryPoint)
{
