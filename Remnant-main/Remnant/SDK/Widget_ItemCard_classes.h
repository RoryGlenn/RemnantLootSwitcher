...
// 0x00E1 (FullSize[0x032A] - InheritedSize[0x0249])
class UWidget_ItemCard_C : public UWidget_UserWidget_C
{
public:
	unsigned char                                      UnknownData_5OXE[0x7];                                     // 0x0249(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_4AMX[0x5];                                     // 0x031B(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
