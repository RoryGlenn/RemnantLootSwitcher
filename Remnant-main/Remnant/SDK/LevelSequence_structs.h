...
{
	unsigned char                                      UnknownData_DMT7[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FLevelSequenceSnapshotSettings
{
	...
	unsigned char                                      UnknownData_RE6P[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_EZWW[0x50];                                    // 0x0000(0x0050) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_TK6R[0x20];                                    // 0x0000(0x0020) MISSED OFFSET (PADDING)
...
struct FLevelSequencePlayerSnapshot
{
	...
	unsigned char                                      UnknownData_NMJ2[0x4];                                     // 0x0084(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ONHP[0x4];                                     // 0x0094(0x0004) MISSED OFFSET (PADDING)
...
struct FLevelSequenceObject
{
	...
	unsigned char                                      UnknownData_5A4S[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
