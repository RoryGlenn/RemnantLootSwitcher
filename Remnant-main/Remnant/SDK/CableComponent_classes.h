...
// 0x0080 (FullSize[0x0620] - InheritedSize[0x05A0])
...
public:
	...
	unsigned char                                      UnknownData_QDIZ[0x6];                                     // 0x05A2(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GAJX[0x2];                                     // 0x05E6(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_PCI0[0x18];                                    // 0x0608(0x0018) MISSED OFFSET (PADDING)
