...
// BlueprintGeneratedClass Resource_Swamp_IskalHusk.Resource_Swamp_IskalHusk_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Resource_Swamp_IskalHusk.Resource_Swamp_IskalHusk_C");
		return ptr;
	}
