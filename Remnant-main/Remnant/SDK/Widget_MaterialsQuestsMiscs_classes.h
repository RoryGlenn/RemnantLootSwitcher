...
// 0x01A7 (FullSize[0x03F0] - InheritedSize[0x0249])
class UWidget_MaterialsQuestsMiscs_C : public UWidget_UserWidget_C
{
public:
	unsigned char                                      UnknownData_MXEU[0x7];                                     // 0x0249(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_7URK[0x4];                                     // 0x0374(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_OJ2U[0x7];                                     // 0x0381(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_M3BQ[0x4];                                     // 0x03AC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      Liquid_Escape[0x28];                                       // 0x03C8(0x0028) UNKNOWN PROPERTY: SoftClassProperty Widget_MaterialsQuestsMiscs.Widget_MaterialsQuestsMiscs_C.Liquid Escape
	...
	void BndEvt__InventoryList_K2Node_ComponentBoundEvent_0_OnSelectItem__DelegateSignature(int ItemID, const struct FInspectInfo& InspectInfo, bool Comparing, const struct FInspectInfo& InspectInfoCompare, bool ShowIngredients, const struct FRecipeInfo& Recipe, class UClass* ItemBP);
	...
	void RefocusList();
	void OnSelectItem_Event(int ItemID, const struct FInspectInfo& InspectInfo, bool Comparing, const struct FInspectInfo& InspectInfoCompare, bool ShowIngredients, const struct FRecipeInfo& Recipe, class UClass* ItemBP);
