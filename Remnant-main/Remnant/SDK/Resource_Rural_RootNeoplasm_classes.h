...
// BlueprintGeneratedClass Resource_Rural_RootNeoplasm.Resource_Rural_RootNeoplasm_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Resource_Rural_RootNeoplasm.Resource_Rural_RootNeoplasm_C");
		return ptr;
	}
