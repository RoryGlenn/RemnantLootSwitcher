...
// 0x011B (FullSize[0x035B] - InheritedSize[0x0240])
...
public:
	...
	unsigned char                                      UnknownData_BUCB[0x4];                                     // 0x02A4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	void SetInspectInfo(class UInventoryComponent* Inventory, int ItemID, const struct FInspectInfo& InspectInfo, bool Comparing, const struct FInspectInfo& InspectInfoCompare);
	...
	void BndEvt__RangedWeapon_K2Node_ComponentBoundEvent_0_OnSubAction__DelegateSignature(const struct FText& ActionLabel);
