...
void AConsumable_GreenLeaf_C::ModifyInspectInfo(class AActor* Actor, class UItemInstanceData* InInstanceData, struct FInspectInfo* Info, bool* Rtn)
{
...
void AConsumable_GreenLeaf_C::DoAction(class UActionComponent* ActionComponent, class AActor* Cause, class AActor* Target)
{
...
void AConsumable_GreenLeaf_C::ExecuteUbergraph_Consumable_GreenLeaf(int EntryPoint)
{
