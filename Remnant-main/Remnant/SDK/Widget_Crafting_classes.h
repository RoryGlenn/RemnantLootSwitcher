...
// 0x00D7 (FullSize[0x0320] - InheritedSize[0x0249])
class UWidget_Crafting_C : public UWidget_UserWidget_C
{
public:
	unsigned char                                      UnknownData_6AJJ[0x7];                                     // 0x0249(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	void Construct();
	void OnSelectRecipe_Event_1(const struct FRecipeInfo& Recipe, class UWidget_Recipe_C* RecipeWidget);
