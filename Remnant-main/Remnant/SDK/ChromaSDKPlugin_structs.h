...
struct FChromaSDKColorFrame1D
{
	...
	unsigned char                                      UnknownData_PAK1[0x8];                                     // 0x0010(0x0008) MISSED OFFSET (PADDING)
...
struct FChromaSDKColorFrame2D
{
	...
	unsigned char                                      UnknownData_I2H7[0x8];                                     // 0x0010(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_H6JF[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
{
	int                                                Result;                                                    // 0x0000(0x0004) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
