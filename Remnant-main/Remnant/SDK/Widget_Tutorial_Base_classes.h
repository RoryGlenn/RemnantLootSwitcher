...
// 0x0090 (FullSize[0x02D9] - InheritedSize[0x0249])
class UWidget_Tutorial_Base_C : public UWidget_UserWidget_C
{
public:
	unsigned char                                      UnknownData_Q6GY[0x7];                                     // 0x0249(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_51NX[0x4];                                     // 0x02C4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
