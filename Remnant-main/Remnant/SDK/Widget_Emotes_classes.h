...
// 0x00D2 (FullSize[0x0312] - InheritedSize[0x0240])
...
public:
	...
	unsigned char                                      UnknownData_ENKJ[0x3];                                     // 0x02E9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_LKS7[0x3];                                     // 0x0309(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
