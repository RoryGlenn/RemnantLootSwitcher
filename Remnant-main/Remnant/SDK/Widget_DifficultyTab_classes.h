...
public:
	...
	unsigned char                                      UnknownData_OZ9R[0x4];                                     // 0x0344(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	void SetDifficultyDescription(const struct FText& InDescription);
	void Construct();
