...
void UBP_RemnantGameInstance_C::SpawnStatusChangeDialog(const struct FText& Message)
{
...
// Parameters:
// struct FText                   Message                        (BlueprintVisible, BlueprintReadOnly, Parm)
void UBP_RemnantGameInstance_C::AddStatusChangeDialog(const struct FText& Message)
{
...
void UBP_RemnantGameInstance_C::StatusChangeDialogResult(const struct FName& Result)
{
...
void UBP_RemnantGameInstance_C::OnShowEventMessage_Event_1(const struct FText& Heading, const struct FText& Message)
{
...
void UBP_RemnantGameInstance_C::OnShowMatchmakingEventMessage_Event_1(const struct FText& Heading, const struct FText& Message, bool AlwaysOnTop)
{
...
// Parameters:
// struct FName                   Result                         (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
void UBP_RemnantGameInstance_C::OnDialogResult_Event_1(const struct FName& Result)
{
