...
// 0x0073 (FullSize[0x04D8] - InheritedSize[0x0465])
class ABP_VeilOfTheBlackTear_Shield_C : public ABP_BreakableActor_C
{
public:
	unsigned char                                      UnknownData_3YV7[0x3];                                     // 0x0465(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	void OnWorldReset();
	void BndEvt__ShieldMesh_K2Node_ComponentBoundEvent_1_ComponentBeginOverlapSignature__DelegateSignature(class UPrimitiveComponent* OverlappedComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int OtherBodyIndex, bool bFromSweep, const struct FHitResult& SweepResult);
