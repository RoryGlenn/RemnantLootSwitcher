...
// BlueprintGeneratedClass SpawnPoint_Waypoint_Survival.SpawnPoint_Waypoint_Survival_C
// 0x0020 (FullSize[0x03A0] - InheritedSize[0x0380])
class ASpawnPoint_Waypoint_Survival_C : public ASpawnPoint
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass SpawnPoint_Waypoint_Survival.SpawnPoint_Waypoint_Survival_C");
		return ptr;
	}
