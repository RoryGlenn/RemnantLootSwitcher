...
// BlueprintGeneratedClass Tracer_Pan_Boss.Tracer_Pan_Boss_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Tracer_Pan_Boss.Tracer_Pan_Boss_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_Tracer_Pan_Boss(int EntryPoint);
};
