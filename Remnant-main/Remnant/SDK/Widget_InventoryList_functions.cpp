...
void UWidget_InventoryList_C::SetItemType(class UClass* Type, class UClass* Category, bool FocusEquippedItem, const struct FName& EquipSlotName)
{
...
void UWidget_InventoryList_C::AddInventoryItem(struct FInventoryItem* Item, class UInventoryComponent* Inventory, int ItemIndex)
{
...
// class UClass*                  ItemBP                         (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
void UWidget_InventoryList_C::OnSelectItem__DelegateSignature(int ItemID, const struct FInspectInfo& InspectInfo, bool Comparing, const struct FInspectInfo& InspectInfoCompare, bool ShowIngredients, const struct FRecipeInfo& Recipe, class UClass* ItemBP)
{
