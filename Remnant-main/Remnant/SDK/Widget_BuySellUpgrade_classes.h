...
// 0x0118 (FullSize[0x0361] - InheritedSize[0x0249])
class UWidget_BuySellUpgrade_C : public UWidget_UserWidget_C
{
public:
	unsigned char                                      UnknownData_HELY[0x7];                                     // 0x0249(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_OD14[0x3];                                     // 0x0345(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	void Construct();
	void OnSelectItem(int ItemID, const struct FInspectInfo& InspectInfo, bool Comparing, const struct FInspectInfo& InspectInfoCompare, bool ShowIngredients, const struct FRecipeInfo& Recipe, class UClass* ItemBP);
