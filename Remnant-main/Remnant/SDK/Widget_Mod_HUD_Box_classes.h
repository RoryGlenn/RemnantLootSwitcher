...
// 0x0091 (FullSize[0x02DA] - InheritedSize[0x0249])
class UWidget_Mod_HUD_Box_C : public UWidget_UserWidget_C
{
public:
	unsigned char                                      UnknownData_ERRD[0x7];                                     // 0x0249(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_K25E[0x6];                                     // 0x02C2(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
