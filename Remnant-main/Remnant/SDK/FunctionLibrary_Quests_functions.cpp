...
void UFunctionLibrary_Quests_C::STATIC_IsPlayerAliveCheck(class APlayerState* PlayerState, class UObject* __WorldContext, bool* Alive)
{
	...
	static auto defaultObj = StaticClass()->CreateDefaultObject<UFunctionLibrary_Quests_C>();
...
// class UObject*                 __WorldContext                 (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
void UFunctionLibrary_Quests_C::STATIC_Put_NPC_on_a_Path(const struct FName& Path_Point_Tag, class URemnantQuestEntity* Quest_Entity, class UObject* __WorldContext)
{
...
// class UObject*                 __WorldContext                 (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
void UFunctionLibrary_Quests_C::STATIC_If_Quest_is_Active_Execute_Event(class UObject* WorldContextObject, const struct FName& Quest_Name_ID, const struct FName& Event_Name, class UObject* __WorldContext)
{
	...
	UFunctionLibrary_Quests_C_If_Quest_is_Active_Execute_Event_Params params;
...
// class UObject*                 __WorldContext                 (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
void UFunctionLibrary_Quests_C::STATIC_Set_Quest_Entity_State(class URemnantQuestEntity* Quest_Entity, const struct FName& State, class UObject* __WorldContext)
{
...
// class UObject*                 __WorldContext                 (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                           ReturnValue                    (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor)
bool UFunctionLibrary_Quests_C::STATIC_Is_Quest_Active_by_Name_ID(const struct FName& Quest_Name_ID, class UObject* World_Context, class UObject* __WorldContext)
{
	...
	UFunctionLibrary_Quests_C_Is_Quest_Active_by_Name_ID_Params params;
	params.Quest_Name_ID = Quest_Name_ID;
