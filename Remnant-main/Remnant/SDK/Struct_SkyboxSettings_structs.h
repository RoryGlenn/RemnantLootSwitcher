...
struct FStruct_SkyboxSettings
{
	...
	unsigned char                                      UnknownData_D3RZ[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QCXF[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	unsigned char                                      SunMaterial_103_195067FE4BCF6863F8DF438B12A9FFF6[0x28];    // 0x0030(0x0028) UNKNOWN PROPERTY: SoftObjectProperty Struct_SkyboxSettings.Struct_SkyboxSettings.SunMaterial_103_195067FE4BCF6863F8DF438B12A9FFF6
	unsigned char                                      SunLightFunction_104_B4558D8E4EB1A93A8E454DBFEB093ACC[0x28]; // 0x0058(0x0028) UNKNOWN PROPERTY: SoftObjectProperty Struct_SkyboxSettings.Struct_SkyboxSettings.SunLightFunction_104_B4558D8E4EB1A93A8E454DBFEB093ACC
	unsigned char                                      SkyboxMaterial_105_B025C729497C7696CB2EF9A4265C03B9[0x28]; // 0x0080(0x0028) UNKNOWN PROPERTY: SoftObjectProperty Struct_SkyboxSettings.Struct_SkyboxSettings.SkyboxMaterial_105_B025C729497C7696CB2EF9A4265C03B9
	unsigned char                                      CloudMaterial_106_454DB579445F8ECF060AD899A61658D1[0x28];  // 0x00A8(0x0028) UNKNOWN PROPERTY: SoftObjectProperty Struct_SkyboxSettings.Struct_SkyboxSettings.CloudMaterial_106_454DB579445F8ECF060AD899A61658D1
	...
	unsigned char                                      UnknownData_1CFR[0x4];                                     // 0x012C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      AmbientParticleSystem_109_A70C062541963D467A2246AEA6038EF0[0x28]; // 0x0668(0x0028) UNKNOWN PROPERTY: SoftObjectProperty Struct_SkyboxSettings.Struct_SkyboxSettings.AmbientParticleSystem_109_A70C062541963D467A2246AEA6038EF0
	unsigned char                                      CharacterParticleSystem_111_67C74FDB4172849313CAB9844AA53537[0x28]; // 0x0690(0x0028) UNKNOWN PROPERTY: SoftObjectProperty Struct_SkyboxSettings.Struct_SkyboxSettings.CharacterParticleSystem_111_67C74FDB4172849313CAB9844AA53537
