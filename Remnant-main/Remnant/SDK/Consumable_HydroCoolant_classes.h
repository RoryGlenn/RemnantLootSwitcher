...
{
public:
	unsigned char                                      UnknownData_LYPM[0x7];                                     // 0x0629(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Consumable_HydroCoolant.Consumable_HydroCoolant_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_Consumable_HydroCoolant(int EntryPoint);
};
