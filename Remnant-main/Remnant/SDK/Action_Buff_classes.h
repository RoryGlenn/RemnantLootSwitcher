...
// 0x0063 (FullSize[0x02C3] - InheritedSize[0x0260])
...
public:
	...
	unsigned char                                      UnknownData_977R[0x3];                                     // 0x026D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ZHY2[0x3];                                     // 0x0285(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
