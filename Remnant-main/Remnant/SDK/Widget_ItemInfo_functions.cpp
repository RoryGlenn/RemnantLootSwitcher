...
void UWidget_ItemInfo_C::SetInspectInfo(class UInventoryComponent* Inventory, int ItemID, const struct FInspectInfo& InspectInfo, bool Comparing, const struct FInspectInfo& InspectInfoCompare)
{
...
void UWidget_ItemInfo_C::BndEvt__RangedWeapon_K2Node_ComponentBoundEvent_0_OnSubAction__DelegateSignature(const struct FText& ActionLabel)
{
...
// Parameters:
// struct FText                   ActionLabel                    (BlueprintVisible, BlueprintReadOnly, Parm)
void UWidget_ItemInfo_C::OnSubAction__DelegateSignature(const struct FText& ActionLabel)
{
