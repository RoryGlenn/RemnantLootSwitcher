...
struct FGfeSDKCreateResponse
{
	...
	unsigned char                                      UnknownData_V0KJ[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FGfeSDKHighlightDefinition
{
	...
	unsigned char                                      UnknownData_RG8A[0x5];                                     // 0x0013(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FGfeSDKHighlightGroupView
{
	...
	unsigned char                                      UnknownData_79AH[0x6];                                     // 0x0012(0x0006) MISSED OFFSET (PADDING)
...
struct FGfeSDKHighlightCloseGroupParams
{
	...
	unsigned char                                      UnknownData_67DH[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (PADDING)
...
struct FGfeSDKCreateInputParams
{
	...
	unsigned char                                      UnknownData_JNTG[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (PADDING)
