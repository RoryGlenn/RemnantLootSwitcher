...
struct UWidget_Traits_C_BndEvt__Widget_TraitList_K2Node_ComponentBoundEvent_106_OnSelectTrait__DelegateSignature_Params
{
...
struct UWidget_Traits_C_BndEvt__ExitBtn_K2Node_ComponentBoundEvent_1_OnAdvButtonClickedEvent__DelegateSignature_Params
{
...
struct UWidget_Traits_C_BndEvt__AdvancedStatsBtn_K2Node_ComponentBoundEvent_2_OnAdvButtonClickedEvent__DelegateSignature_Params
{
	class UWidget*                                     Widget;                                                    // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
struct UWidget_Traits_C_BndEvt__SpendTraitBtn_K2Node_ComponentBoundEvent_0_OnAdvButtonClickedEvent__DelegateSignature_Params
{
	class UWidget*                                     Widget;                                                    // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
struct UWidget_Traits_C_BndEvt__ToggleDescription_K2Node_ComponentBoundEvent_3_OnAdvButtonClickedEvent__DelegateSignature_Params
{
	class UWidget*                                     Widget;                                                    // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// Function Widget_Traits.Widget_Traits_C.RefocusScrollList
struct UWidget_Traits_C_RefocusScrollList_Params
{
};

// Function Widget_Traits.Widget_Traits_C.Construct
struct UWidget_Traits_C_Construct_Params
{
};

// Function Widget_Traits.Widget_Traits_C.ExecuteUbergraph_Widget_Traits
struct UWidget_Traits_C_ExecuteUbergraph_Widget_Traits_Params
{
	int                                                EntryPoint;                                                // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// Function Widget_Traits.Widget_Traits_C.AdvancedStats__DelegateSignature
struct UWidget_Traits_C_AdvancedStats__DelegateSignature_Params
{
};
