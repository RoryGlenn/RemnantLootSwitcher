...
// 0x0091 (FullSize[0x03C1] - InheritedSize[0x0330])
...
public:
	...
	unsigned char                                      UnknownData_RVA8[0x4];                                     // 0x0384(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_RDUU[0x7];                                     // 0x0391(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_IOPP[0x5];                                     // 0x03AB(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	void RemoveCheckpointNotification(class ACharacter_Master_Player_C* Player, const struct FName& NameID);
	void AddCheckpointNotification(class ACharacter_Master_Player_C* Player, const struct FName& NameID, float DurationOverride);
	void IsCheckpointNotificationActive(class ACharacter_Master_Player_C* Player, const struct FName& NameID, bool* Out);
	...
	void BndEvt__ProximityTrigger_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature(class UPrimitiveComponent* OverlappedComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int OtherBodyIndex, bool bFromSweep, const struct FHitResult& SweepResult);
	...
	void BndEvt__TutorialProximityTrigger_K2Node_ComponentBoundEvent_2_ComponentBeginOverlapSignature__DelegateSignature(class UPrimitiveComponent* OverlappedComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int OtherBodyIndex, bool bFromSweep, const struct FHitResult& SweepResult);
	...
	void BndEvt__StateMachine_K2Node_ComponentBoundEvent_0_InteractiveDelegate__DelegateSignature(const struct FName& StateName, class AActor* Other);
	void OnShowPrompt();
