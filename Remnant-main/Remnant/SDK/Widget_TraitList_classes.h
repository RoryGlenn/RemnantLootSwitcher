...
{
public:
	unsigned char                                      UnknownData_ATO5[0x7];                                     // 0x0249(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_LR3J[0x3];                                     // 0x02A9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	void AddTrait(const struct FTraitInfo& TraitInfo, int Index);
	...
	void OnTraitClicked__DelegateSignature(const struct FTraitInfo& TraitInfo);
	void OnSelectTrait__DelegateSignature(const struct FTraitInfo& TraitInfo, class UWidget_Trait_C* TraitWidget);
};
