...
// 0x0082 (FullSize[0x0332] - InheritedSize[0x02B0])
...
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass Widget_BinaryUserSetting.Widget_BinaryUserSetting_C");
		return ptr;
	}
	...
	void Construct();
	void ExecuteUbergraph_Widget_BinaryUserSetting(int EntryPoint);
};
