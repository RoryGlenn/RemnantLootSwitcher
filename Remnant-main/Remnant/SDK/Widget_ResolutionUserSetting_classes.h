...
// WidgetBlueprintGeneratedClass Widget_ResolutionUserSetting.Widget_ResolutionUserSetting_C
// 0x00A2 (FullSize[0x0352] - InheritedSize[0x02B0])
...
public:
	...
	class UResolutionUserSetting*                      Setting;                                                   // 0x0348(0x0008) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash)
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass Widget_ResolutionUserSetting.Widget_ResolutionUserSetting_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_Widget_ResolutionUserSetting(int EntryPoint);
};
