...
// int                            FirstVertexNumberToRemove      (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// int                            NumVerticesToRemove            (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct FVertexID UEditableMesh::STATIC_MakeVertexID(int VertexIndex)
{
	...
	static auto defaultObj = StaticClass()->CreateDefaultObject<UEditableMesh>();
...
// Parameters:
// struct FPolygonID              PolygonID                      (ConstParm, Parm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// int                            InsertBeforeVertexNumber       (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
class UEditableMesh* UEditableMeshFactory::STATIC_MakeEditableMesh(class UPrimitiveComponent* PrimitiveComponent, int LODIndex)
{
	...
	static auto defaultObj = StaticClass()->CreateDefaultObject<UEditableMeshFactory>();
	defaultObj->ProcessEvent(fn, &params);
	fn->FunctionFlags = flags;
