...
// 0x003C (FullSize[0x036C] - InheritedSize[0x0330])
...
public:
	...
	class ARemnantCharacter*                           NewVar_1;                                                  // 0x0360(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int                                                ActionID;                                                  // 0x0368(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	void ExecuteUbergraph_BP_Root_Rot_Cloud(int EntryPoint);
};
