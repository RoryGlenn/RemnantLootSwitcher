...
// 0x0093 (FullSize[0x02DC] - InheritedSize[0x0249])
class UWidget_QuestNotification_Quest_C : public UWidget_UserWidget_C
{
public:
	unsigned char                                      UnknownData_XAH7[0x7];                                     // 0x0249(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_US46[0x5];                                     // 0x02B3(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	void HasObjective(const struct FName& Name, bool* Out);
