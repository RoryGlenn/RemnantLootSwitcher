...
// BlueprintGeneratedClass Breakable_Snow_Barrel_02_Snowy.Breakable_Snow_Barrel_02_Snowy_C
// 0x0030 (FullSize[0x04E0] - InheritedSize[0x04B0])
class ABreakable_Snow_Barrel_02_Snowy_C : public ABP_BreakableActor_2States_C
{
public:
	class UStaticMeshComponent*                        SM_Swamp_Crate_01_DM_010;                                  // 0x04B0(0x0008) (BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
	class UStaticMeshComponent*                        SM_Swamp_Crate_01_DM_011;                                  // 0x04B8(0x0008) (BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Breakable_Snow_Barrel_02_Snowy.Breakable_Snow_Barrel_02_Snowy_C");
		return ptr;
	}
