...
// 0x0078 (FullSize[0x0B68] - InheritedSize[0x0AF0])
...
public:
	...
	unsigned char                                      UnknownData_1QSQ[0x3];                                     // 0x0B51(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_LXFB[0x4];                                     // 0x0B5C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
