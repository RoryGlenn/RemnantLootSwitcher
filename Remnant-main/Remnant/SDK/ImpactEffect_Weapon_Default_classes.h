...
// BlueprintGeneratedClass ImpactEffect_Weapon_Default.ImpactEffect_Weapon_Default_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass ImpactEffect_Weapon_Default.ImpactEffect_Weapon_Default_C");
		return ptr;
	}
