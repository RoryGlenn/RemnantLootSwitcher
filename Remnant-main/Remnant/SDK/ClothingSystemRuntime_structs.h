...
struct FClothParameterMask_PhysMesh
{
	...
	unsigned char                                      UnknownData_QFC9[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_AB6U[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_C9NE[0x7];                                     // 0x0029(0x0007) MISSED OFFSET (PADDING)
...
struct FClothConfig
{
	...
	unsigned char                                      UnknownData_JZIO[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_SJ23[0x3];                                     // 0x00BD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FClothLODData
{
	...
	unsigned char                                      UnknownData_DE4I[0x20];                                    // 0x00D8(0x0020) MISSED OFFSET (PADDING)
