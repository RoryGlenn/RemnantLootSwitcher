...
// 0x0087 (FullSize[0x02D0] - InheritedSize[0x0249])
class UWidget_InspectableHUD_C : public UWidget_UserWidget_C
{
public:
	unsigned char                                      UnknownData_DMFH[0x7];                                     // 0x0249(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HYXS[0x7];                                     // 0x02A9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QWWJ[0x1];                                     // 0x02BF(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	void Construct();
	void OnInteractive_Event_1(const struct FName& StateName, class AActor* Other);
