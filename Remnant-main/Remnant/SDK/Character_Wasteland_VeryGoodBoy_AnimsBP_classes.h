...
// 0x1904 (FullSize[0x23E0] - InheritedSize[0x0ADC])
class UCharacter_Wasteland_VeryGoodBoy_AnimsBP_C : public URemnantAnimInstance
{
public:
	unsigned char                                      UnknownData_H93C[0x4];                                     // 0x0ADC(0x0004) Fix Super Size
	...
	unsigned char                                      UnknownData_YPU4[0x8];                                     // 0x1E28(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
