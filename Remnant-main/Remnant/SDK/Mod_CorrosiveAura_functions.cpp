...
void AMod_CorrosiveAura_C::GetEnemyDefenseReductionScalar(float* Out)
{
...
void AMod_CorrosiveAura_C::DoAction(class UActionComponent* ActionComponent, int* ActionID)
{
...
void AMod_CorrosiveAura_C::ModifyInspectInfo(class AActor* Actor, class UItemInstanceData* InInstanceData, struct FInspectInfo* Info, bool* Rtn)
{
