...
void UWidget_InventoryItem_C::MarkUpgradeIngredientsForRemoval(const struct FRecipeInfo& Recipe)
{
...
void UWidget_InventoryItem_C::SetInspectInfo(const struct FInspectInfo& InspectInfo)
{
...
// bool                           Out                            (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor)
void UWidget_InventoryItem_C::GetPrimaryStat(const struct FInspectInfo& InspectInfo, struct FInspectStat* InspectStat, bool* Out)
{
...
// int                            Cost                           (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
void UWidget_InventoryItem_C::GetRecipeCost(const struct FRecipeInfo& RecipeInfo, int* Cost)
{
...
void UWidget_InventoryItem_C::OnUpgradeResult(const struct FName& Result)
{
...
// Parameters:
// struct FName                   Result                         (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
void UWidget_InventoryItem_C::OnBuyResult(const struct FName& Result)
{
