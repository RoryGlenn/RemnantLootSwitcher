...
public:
	...
	float                                              Radius;                                                    // 0x0248(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	void OnActionStart();
	void ExecuteUbergraph_Action_Mod_ColdSpear_ApplyFrostbite(int EntryPoint);
};
