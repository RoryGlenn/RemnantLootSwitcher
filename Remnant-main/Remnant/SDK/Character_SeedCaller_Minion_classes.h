...
// 0x0048 (FullSize[0x0CE0] - InheritedSize[0x0C98])
...
public:
	...
	unsigned char                                      UnknownData_72A3[0x3];                                     // 0x0CC5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QC0S[0x4];                                     // 0x0CCC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
