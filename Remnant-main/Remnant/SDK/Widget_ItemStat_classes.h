...
// 0x0135 (FullSize[0x038A] - InheritedSize[0x0255])
class UWidget_ItemStat_C : public UWidget_StatBase_C
{
public:
	unsigned char                                      UnknownData_S6LH[0x3];                                     // 0x0255(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_IN1B[0x7];                                     // 0x02F9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
