...
public:
	...
	unsigned char                                      UnknownData_QYVD[0x4];                                     // 0x029C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      Images[0x10];                                              // 0x02C0(0x0010) UNKNOWN PROPERTY: ArrayProperty Widget_Loading.Widget_Loading_C.Images
	bool                                               IsPC;                                                      // 0x02D0(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)
	unsigned char                                      UnknownData_C4AD[0x3];                                     // 0x02D1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
