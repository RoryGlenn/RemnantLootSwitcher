...
// BlueprintGeneratedClass Armor_Legs_Hunter_PreOrder.Armor_Legs_Hunter_PreOrder_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Armor_Legs_Hunter_PreOrder.Armor_Legs_Hunter_PreOrder_C");
		return ptr;
	}
