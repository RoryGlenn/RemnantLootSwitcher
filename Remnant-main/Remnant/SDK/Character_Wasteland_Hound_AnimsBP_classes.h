...
// 0x1E7C (FullSize[0x2958] - InheritedSize[0x0ADC])
class UCharacter_Wasteland_Hound_AnimsBP_C : public URemnantAnimInstance
{
public:
	unsigned char                                      UnknownData_AA2H[0x4];                                     // 0x0ADC(0x0004) Fix Super Size
	...
	unsigned char                                      UnknownData_HV80[0x8];                                     // 0x1E28(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
