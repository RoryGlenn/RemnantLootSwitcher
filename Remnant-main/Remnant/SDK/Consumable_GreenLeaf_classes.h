...
// BlueprintGeneratedClass Consumable_GreenLeaf.Consumable_GreenLeaf_C
// 0x001F (FullSize[0x0648] - InheritedSize[0x0629])
class AConsumable_GreenLeaf_C : public AItem_Potion_Base_C
{
public:
	unsigned char                                      UnknownData_KWYS[0x7];                                     // 0x0629(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	float                                              CorrosiveResistance;                                       // 0x0640(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Consumable_GreenLeaf.Consumable_GreenLeaf_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_Consumable_GreenLeaf(int EntryPoint);
};
