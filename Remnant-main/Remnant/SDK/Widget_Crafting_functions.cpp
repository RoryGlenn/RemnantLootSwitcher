...
void UWidget_Crafting_C::OnSelectRecipe_Event_1(const struct FRecipeInfo& Recipe, class UWidget_Recipe_C* RecipeWidget)
{
...
void UWidget_Crafting_C::OnDialogResult_Event_1(const struct FName& Result)
{
