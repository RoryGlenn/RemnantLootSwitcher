...
void UBP_FunctionLibrary_C::STATIC_GetMinionDamageScalar(class UObject* Minion, class UObject* __WorldContext, float* Scalar, bool* IsValid)
{
	...
	static auto defaultObj = StaticClass()->CreateDefaultObject<UBP_FunctionLibrary_C>();
...
// class UObject*                 __WorldContext                 (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
void UBP_FunctionLibrary_C::STATIC_Update_Trigger_Objects(TArray<class AActor*>* Trigger_Objects, bool State, class UObject* __WorldContext)
{
