...
public:
	...
	unsigned char                                      UnknownData_S8CY[0x6];                                     // 0x0282(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	void UnbindEvents();
	void End(const struct FSequencerPlayerSettings& SequenceSettings, class ULevelSequence* InLevelSequence, class AActor* Instigator);
	void BindEvents();
	void Construct();
