...
// BlueprintGeneratedClass Resource_Snow_JackalsIvory.Resource_Snow_JackalsIvory_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Resource_Snow_JackalsIvory.Resource_Snow_JackalsIvory_C");
		return ptr;
	}
