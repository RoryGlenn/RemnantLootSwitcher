...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Interactive_Waypoint_SpawnPoint.Interactive_Waypoint_SpawnPoint_C");
		return ptr;
	}


	void UpdateEnabled();
	void BndEvt__PawnDetect_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature(class UPrimitiveComponent* OverlappedComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int OtherBodyIndex, bool bFromSweep, const struct FHitResult& SweepResult);
	...
	void ExecuteUbergraph_Interactive_Waypoint_SpawnPoint(int EntryPoint);
};
