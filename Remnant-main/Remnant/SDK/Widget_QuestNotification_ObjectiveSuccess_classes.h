...
// 0x00CF (FullSize[0x0318] - InheritedSize[0x0249])
class UWidget_QuestNotification_ObjectiveSuccess_C : public UWidget_UserWidget_C
{
public:
	unsigned char                                      UnknownData_DR82[0x7];                                     // 0x0249(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_8A63[0x4];                                     // 0x02FC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
