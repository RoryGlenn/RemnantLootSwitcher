...
{
public:
	unsigned char                                      UnknownData_QPX0[0x7];                                     // 0x0629(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	void ExecuteUbergraph_Consumable_OilskinTonic(int EntryPoint);
};
