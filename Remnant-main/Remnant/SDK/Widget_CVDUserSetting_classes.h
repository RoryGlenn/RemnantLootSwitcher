...
// WidgetBlueprintGeneratedClass Widget_CVDUserSetting.Widget_CVDUserSetting_C
...
public:
	...
	class UColorblindUserSetting*                      Setting;                                                   // 0x0348(0x0008) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash)
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass Widget_CVDUserSetting.Widget_CVDUserSetting_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_Widget_CVDUserSetting(int EntryPoint);
};
