...
// BlueprintGeneratedClass Breakable_Snow_Barrel_Exploding.Breakable_Snow_Barrel_Exploding_C
// 0x0058 (FullSize[0x0508] - InheritedSize[0x04B0])
class ABreakable_Snow_Barrel_Exploding_C : public ABP_BreakableActor_2States_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Breakable_Snow_Barrel_Exploding.Breakable_Snow_Barrel_Exploding_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_Breakable_Snow_Barrel_Exploding(int EntryPoint);
};
