...
public:
	...
	int                                                ActionID;                                                  // 0x0360(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	void ExecuteUbergraph_BP_Cloud_Mod_SporeShot(int EntryPoint);
};
