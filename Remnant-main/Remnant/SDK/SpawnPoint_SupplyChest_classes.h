...
// BlueprintGeneratedClass SpawnPoint_SupplyChest.SpawnPoint_SupplyChest_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass SpawnPoint_SupplyChest.SpawnPoint_SupplyChest_C");
		return ptr;
	}
