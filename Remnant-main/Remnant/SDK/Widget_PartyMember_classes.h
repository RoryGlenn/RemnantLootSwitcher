...
public:
	...
	unsigned char                                      UnknownData_MMSL[0x5];                                     // 0x02C3(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	void OnRequestPing(class AActor* Character, const struct FActionPing& Ping);
