...
void UWidget_HUD_C::GetUserSetting(const struct FName& UserSetting, class UUserSetting** Result)
{
...
void UWidget_HUD_C::UpdateHUDSettings(const struct FName& UserSetting, class UWidget* Widget, TEnumAsByte<EHudSettings> Type, float SizeMin, float SizeMax, bool FixedAspectRatio_)
{
...
void UWidget_HUD_C::OnHudEvent(const struct FName& Event, class UObject* Context)
{
...
void UWidget_HUD_C::OnNotifyTakeDamage_Event_1(const struct FDamageInfo& DamageInfo)
{
...
// float                          Duration                       (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
void UWidget_HUD_C::ShowSummonPopup(const struct FName& SummonerName, float Duration)
{
...
void UWidget_HUD_C::EnteringZoneAnimation(const struct FText& ZoneName)
{
