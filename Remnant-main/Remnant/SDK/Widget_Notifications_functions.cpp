...
// class UClass*                  Emote                          (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
void UWidget_Notifications_C::QueueNotification(TEnumAsByte<ENotificationType> Type, class UClass* Trait, const struct FText& Text, const struct FText& Prompt, class UClass* ItemBP, int Value, bool AccountAward, class UClass* Emote)
{
