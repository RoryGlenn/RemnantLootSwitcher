...
// 0x016A (FullSize[0x041A] - InheritedSize[0x02B0])
...
public:
	...
	unsigned char                                      UnknownData_ZCLW[0x3];                                     // 0x03A5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	void SetGameMode(const struct FText& Label, const struct FText& Description, class UTexture2D* Icon);
