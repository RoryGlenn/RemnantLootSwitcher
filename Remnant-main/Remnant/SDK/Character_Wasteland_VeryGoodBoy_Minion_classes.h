...
// 0x004C (FullSize[0x0CE5] - InheritedSize[0x0C99])
class ACharacter_Wasteland_VeryGoodBoy_Minion_C : public ACharacter_Wasteland_Hound_C
{
public:
	unsigned char                                      UnknownData_Z06P[0x7];                                     // 0x0C99(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_45G6[0x3];                                     // 0x0CC5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_C2YT[0x4];                                     // 0x0CCC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
