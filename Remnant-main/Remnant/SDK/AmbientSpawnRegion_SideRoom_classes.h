...
// BlueprintGeneratedClass AmbientSpawnRegion_SideRoom.AmbientSpawnRegion_SideRoom_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass AmbientSpawnRegion_SideRoom.AmbientSpawnRegion_SideRoom_C");
		return ptr;
	}
